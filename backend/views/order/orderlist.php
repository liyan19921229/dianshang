...
<body>
 <div class="wrap">
  ...
  <div class="operate">
   <form>
    <img src="/public/images/icon_search.gif"/>
  ...
  <table class="list-style Interlaced">
   ...
   <tr>
    <td>
     <input type="checkbox"/>
     <a href="/order/detail">2015041803225</a>
    </td>
    <td class="center">
    ...
    <td class="center">
     <a href="/order/detail" class="inline-block" title="查看订单"><img src="/public/images/icon_view.gif"/></a>
     <a class="inline-block" title="删除订单"><img src="/public/images/icon_trash.gif"/></a>
    </td>
   </tr>
  </table>
  <!-- BatchOperation -->
